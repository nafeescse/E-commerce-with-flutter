...
List<GetAllProductData> getAllProductDataFromJson(String str) => List<GetAllProductData>.from(json.decode(str).map((x) => GetAllProductData.fromJson(x)));

String getAllProductDataToJson(List<GetAllProductData> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
